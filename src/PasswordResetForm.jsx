...
const PasswordResetForm = () => {
  ...
  useEffect(() => {
    ...
    const lastRequestedTime = parseInt(localStorage.getItem("lastRequestedTime"));
  ...
  const handleVerifyEmail = () => {
    if (!requestLink) {
      // Perform the logic to send the verification email to the user.
      // You can call your backend API to request a new verification email.
